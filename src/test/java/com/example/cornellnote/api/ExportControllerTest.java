...
class ExportControllerTest extends ApiTestSupport {
  ...
  void requestExport_shouldReturnJob() throws Exception {
    String response = mockMvc.perform(org.springframework.test.web.servlet.request.MockMvcRequestBuilders.post("/api/notes/{noteId}/export/pdf", "11111111-2222-3333-4444-555555555555")
  ...
  void getExportStatus_shouldReturnStatus() throws Exception {
    String response = performGet("/api/exports/{exportId}", "exp-001")
