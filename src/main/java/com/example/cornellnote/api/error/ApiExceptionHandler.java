...
public class ApiExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleUnknown(Exception ex, HttpServletRequest request) {
    return buildResponse("INTERNAL_ERROR", "Unexpected error", request, HttpStatus.INTERNAL_SERVER_ERROR);
  }

  private ResponseEntity<ErrorResponse> buildResponse(String code, String message, HttpServletRequest request,
      HttpStatus status) {
