...
public class AuthController {
  ...
  @PostMapping("/signup")
  public ResponseEntity<AuthSession> signup(@Valid @RequestBody AuthCredentials request) {
    return ResponseEntity.status(HttpStatus.CREATED).body(authService.signup(request));
  }

  @PostMapping("/login")
  public ResponseEntity<AuthSession> login(@Valid @RequestBody AuthCredentials request) {
